    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      if($_SESSION['id'] ==0)
      {
        ...
        ?>
          ...
          <li><a href="./logout.php" data-toggle="modal"><?php echo $tr['categorie_log6'] ?></a></li>
          <li class="btn-trial"><a href="./profil.php?id=<?php echo $_SESSION['id'] ?>" data-toggle="modal"><?php echo $tr['categorie_log7'] ?></a></li>
        <?php
      }
      ?>
